...
#define QUESTION 3 //nb_questions dans le fichier


void init_ef(enigme_f *e)
{
char reponses[4][16];char question[32];char text[5];
FILE *fp;
   char buff[255];
...
void afficher_e(enigme_f e,SDL_Surface *screen,int x)
{
...
else afficher_e(e,screen,0);b=1;}
}SDL_Flip(screen);
